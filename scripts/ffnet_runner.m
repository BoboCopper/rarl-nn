% -----------------------------------------------
% Simple runner template to use with
%  'ffnet.m` and `trainingdata.m`
%
% This file automates the following things
%   * automatic plotting
%   * allows the injection into the training process (do ~x every ~n epoch)
% 
% -----------------------------------------------
